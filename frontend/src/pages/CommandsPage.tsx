...
import { Plus, Terminal, Copy, Trash2 } from "lucide-react";
...
export default function CommandsPage() {
  ...
  const [form, setForm] = useState({ name: "", category: "network", command_text: "", description: "", tool: "", operating_system: "any" });
  ...
  type Cmd = { id: string; name: string; category: string; command_text: string; tool?: string; operating_system: string; usage_count: number; is_favorite: boolean };
